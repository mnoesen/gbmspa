...
gbmspa.shell = (function () {
  ...
  // Example  : gbmspa.shell.initModule( $('#app_div_id') );
  // Purpose  :
  ...
  initModule = function ( $container ) {
    ...
    gbmspa.chat.configModule({
      ...
      chat_model      : gbmspa.model.chat,
      people_model    : gbmspa.model.people
    });
    gbmspa.chat.initModule( jqueryMap.$container );
